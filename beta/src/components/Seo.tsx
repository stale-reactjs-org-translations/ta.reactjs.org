...
export const Seo = withRouter(
  ({
    title,
    description = 'இது ஒரு பயனர் இடைமுகத்தை உருவாக்குவதற்கான JavaScript நிரல்கூறு ஆகும்.',
    image = '/logo-og.png',
    router,
    children,
    ...
    <Head>
      {/* DEFAULT */}
      <link rel="preconnect" href='https://beta.reactjs.org/fonts/' crossOrigin='anonymous' />
